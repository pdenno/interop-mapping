...
keywords={query, express, \$read, \$reduce, typeof, new, true, false, catch, function, return, null, catch, switch, var, if, in, while, do, else, case, break},
...
A reference implementation of the RADmapper language can be found in \href{https://github.com/pdenno/RADmapper}{this Git repository}.  % \href{<url>}{text} did not work!
...
% I might have this wrong; is there supposed to be a "systems"?
