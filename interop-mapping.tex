...
% latexdiff old.tex interop-mapping.tex > diff.tex
% latexmk -pdf diff
...
%  Corresponding to \bdef{role definitions} like \stt{:element\_name} on Line 6, there is somewhere in the structures assigned to \stt{\$schema1} and \stt{\$schema1}
