...
\textbf{[Discuss use of key() to create more conventional output.
Then discuss the idea of playing with challenging problems in the exerciser, starting with simple queries, and getting bsets
