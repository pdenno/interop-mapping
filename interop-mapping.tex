...
Even with this simple data, there are a few options for designing the relational database.
...
Thus for each \stt{owl/ObjectProperty} we will produce a two-column table to represent both a relation and its inverse (``inverse pairs'');
the column values are resource IRIs.
